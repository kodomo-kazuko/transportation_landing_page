  ...
  return texts.map((text, index) => {
    ...
    return (
      <SwipeWrapper key={index} animation={animationType} delay={index * 300}>
        <div className={`text-4xl text-ub-secondary sm:text-5xl md:text-6xl font-bold lg:ml-10 mt-0 md:  lg:mt-0 mb-4 text-center md:text-left`}>
          {firstLine}
          <br />
          {secondLine}
        </div>
...
const Hero: React.FC = () => {
  ...
  const text = createAnimatedText(["Илүү хялбар  Илүү цогц"], animationType);
      ...
      >
        <div className="flex flex-col space-y-4 md:w-1/2 md:flex md:items-start justify-center md:justify-start md:pl-10">
          ...
          <p className="px-20 text-center sm:px-20 text-lg text-ub-gray sm:text-xl md:text-2xl 3xl:text-3xl lg:ml-10 md:px-0 md:text-left">
            Нийтийн тээврээр үйлчлүүлж буй зорчигч таныг тав тухтай, аюулгүй орчинд зорьсон газраа саадгүй хүрэх боломжоор хангах технологийн шийдэл.
          </p>
          ...
          <div className="flex flex-col sm:flex-col md:flex-row gap-3 lg:pl-10 justify-center sm:justify-center items-center">
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.99 }}>
              <a className="w-1/2 sm:w-auto lg:w-fit 3xl:w-auto focus-visible-class" href="">
                <button className="w-60 sm:w-60 3xl:w-72 text-gray-100 bg-ub-secondary font-semibold rounded-2xl flex items-center justify-center gap-2 p-2">
                  <Image alt="App Store Logo" src={AppStore} width={buttonSize} height={buttonSize} />
            ...
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.99 }}>
              <a className="w-1/2 sm:w-auto lg:w-fit 3xl:w-auto focus-visible-class" href="">
                <button className="w-60 sm:w-60 3xl:w-72 text-gray-100 bg-ub-secondary font-semibold rounded-2xl flex items-center justify-center gap-2 p-2">
                  <Image alt="Play Store Logo" src={PlayStore} width={buttonSize} height={buttonSize} />
        ...
        <div className="z-10 md:w-1/2 md:flex md:items-center md:justify-center relative">
          ...
          <div className="flex justify-center items-center z-10">
            <div className="flex justify-center items-center z-10">
              ...
              >
                <Image src={test} alt="Start Image" width={screenSize * 1.2} height={screenSize * 1.2} priority />
              </motion.div>
            </div>
          </div>
        </div>
