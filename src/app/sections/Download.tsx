  ...
  return (
    <div className="shadow-2xl rounded-xl">
      <ColorWrapper color="transparent">
        ...
        Properties
          pt-8 pb-8 sm:pb-6 lg:p-0 flex flex-col lg:items-center gap-16  overflow-clip justify-center items-center px-4 sm:px-0 mx-5 sm:mx-10"
        >
          ...
          <div className="flex flex-col items-center justify-center w-full sm:w-3/4 lg:w-2/4">
            <div className="flex flex-col sm:flex-row gap-3">
              <a className="w-full lg:w-fit focus-visible-class" href="">
                <button className="w-full lg:w-60  bg-neutral-800 font-semibold text-white rounded-2xl flex items-center border border-gray-400 justify-center gap-2 p-2">
                  <Image
                    alt="App Store Logo"
                    src={AppStore}
                    width={50}
