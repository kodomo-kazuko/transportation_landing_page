...
export default function Download() {
  ...
  return (
    <div className="lg:relative sm:none shadow-2xl rounded-xl">
            ...
            <div className="flex flex-col items-center justify-center lg:w-2/4">
              <div className="flex flex-col sm:flex-row gap-3">
                <a className="w-full lg:w-fit focus-visible-class" href="">
                  <button className="w-full lg:w-60 bg-neutral-800 font-semibold  rounded-2xl flex items-center  justify-center gap-2 p-2">
                    <Image
                      alt="App Store Logo"
                      src={AppStore}
                      width={50}
