      ...
      >
        <div className="z-10 lg:pt-16 text-base-normal items-center ">
          ...
          <h1 className="mb-8 sm:mb-10 font-normal sm:text-base">
            Таны автобус аяллыг хөнгөвчилнө.
          </h1>
        </div>
            ...
            <a className=" w-full lg:w-fit focus-visible-class" href="">
              <button className=" bg-white font-semibold text-gray-700 rounded-2xl flex items-center justify-center gap-2 p-2">
                <Image
                  ...
                  height={50}
                />
                <span>App Store-с татаx</span>
              </button>
            </a>
            <a className="w-full lg:w-fit focus-visible-class" href="">
              <button className="secondary bg-white font-semibold text-gray-700 rounded-2xl flex items-center justify-center gap-2 p-2">
                <Image
                  alt="Play Store Logo"
                  src={PlayStore}
                  width={50}
